...
export class Node {
	...
	constructor(public start: number, public end: number, public children: Node[], public parent: Node | undefined) {
	}
...
export function parse(text: string): HTMLDocument {
	...
	let htmlDocument = new Node(0, text.length, [], undefined);
	let curr : Node | undefined = htmlDocument;
